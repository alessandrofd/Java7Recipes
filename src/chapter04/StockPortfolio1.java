...
/**
 * The StockPortfolio1 class is a continuation of the StockPortfolio class shown in the previous recipe. It adds three
 * methods, summary(), alterList(), and remove(List<String>), that demonstrate alternative methods for iterating over
 * the portfolio map.
 */
public class StockPortfolio1 implements Iterable<Stock> {
    ...
    public void remove(String stock) { portfolio.remove(stock); }
    ...
    @Override
    public Iterator<Stock> iterator() { return portfolio.values().iterator(); }
