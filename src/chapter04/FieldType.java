...
public enum FieldType {
    ...
    PASSWORD("password") {
        ...
        // more uppercase letters, and be a minimum of 6 characters long.
    ...
    EMAIL_ADDRESS("email") {
        ...
        // a combination of alphanumeric characters (hyphens allowed), followed by one
        // or more periods (to separate domains and subdomains), and ending in 2-4
    ...
    PHONE_NUMBER("phone") {
        ...
        // A phone number must contain a minimum of 7 digits. Three optional digits
        // representing the area code may appear in front of the main 7 digits. The
        // area code may, optionally, be surrounded by parenthesis. If an area code
        // is included, the number may optionally be prefixed by a '1 for long distance
        // numbers. Optional hyphens may appear after the country code ('1'), the
        // area code, and the first 3 digits of the 7 digit number.
    ...
    private FieldType(String fieldName) { this.fieldName = fieldName; }
    ...
    public static FieldType lookup(String fieldName) { return nameToFieldTypeMap.get(fieldName.toLowerCase()); }
