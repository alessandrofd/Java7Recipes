...
public class GenericsDemo {
    ...
    public static void main(String[] args) {
        ...
        // warnings and error are left intact to alloy you to study and understand
        ...
        //aList.add("Java 7"); // won't compile, wrong type
        ...
        //dList.add(dNum); // won't compile; dList could be a LinkedList<Integer>
        ...
        gList.set(0, new ArrayList<>(Arrays.asList("a", "b"))); // diamond in method argument

        // new HashMap<>() != new HashMap()
        Map<Integer, List<String>> bMap = new HashMap(); // compiler warning; avoid raw types
